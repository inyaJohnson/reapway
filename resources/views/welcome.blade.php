...
<head>
    ...
    <link
        href="{{url('https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i')}}"
        rel="stylesheet">
    ...
    <link rel="stylesheet" href="{{asset('assets/css/fancybox/jquery.fancybox.min.css')}}" type="text/css"/>
                ...
                <div class="col-sm-6 col-md-8 main-menu">
                    ...
                    <nav class="onepage">
                        <ul>
                            ...
                            <li class="nav-btn"><a href="{{route('login')}}">Sign In</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-12">
                        <div class="diamond-icon">
                            <img src="{{asset('assets/images/coinpool-c.png')}}" alt="">
                        </div>
                    </div>
        ...
        <div class="benefit-section platinum-layout white-bg p-t" id="features">
            <div class="container">
                ...
                <div class="banafits-circle">
                    <div class="icon">
                        <img src="{{asset('assets/images/large-c-icon.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<script src="{{asset('assets/js/onpagescroll.js')}}"></script>
<script src="{{asset('assets/js/wow.min.js')}}"></script>
<script src="{{asset('assets/js/jquery.countdown.js')}}"></script>
<script src="{{asset('assets/js/owl.carousel.js')}}"></script>
<script src="{{asset('assets/js/slick.min.js')}}"></script>
<script src="{{asset('assets/js/Chart.js')}}"></script>
<script src="{{asset('assets/js/chart-function.js')}}"></script>
<script src="{{asset('assets/js/fancybox/jquery.fancybox.min.js')}}"></script>
<script src="{{asset('assets/js/script.js')}}"></script>
<script src="{{asset('assets/js/particles.js')}}"></script>
<script src="{{asset('assets/js/gold-app.js')}}"></script>
