<header>
                ...
                <ul class="navbar-nav mr-auto mobile-menu">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="{{route('investment.invest')}}" class="list-group-item list-group-item-action  waves-effect ">
                            <i class="fas fa-user mr-3"></i>Invest</a>
                        <a href="account.html" class="list-group-item list-group-item-action waves-effect ">
                            <i class="fas fa-table mr-3"></i>Account</a>
                        <a href="{{route('withdrawal.index')}}" class="list-group-item list-group-item-action waves-effect">
                            <i class="fas fa-map mr-3"></i>Withdraw</a>
                        <a href="history.html" class="list-group-item list-group-item-action waves-effect  ">
                            <i class="fas fa-archway mr-3"></i>History</a>
                        <a href="{{route('settings.index')}}" class="list-group-item list-group-item-action waves-effect">
                            <i class="fas fa-archway mr-3"></i>Settings</a>
    ...
    <div class="sidebar-fixed position-fixed">
        ...
        <div class="list-group list-group-flush">
            ...
            <a href="{{route('investment.invest')}}" class="list-group-item list-group-item-action waves-effect  text-white">
                <i class="fas fa-user mr-3"></i>Invest</a>
            <a href="account.html" class="list-group-item list-group-item-action waves-effect  text-white">
                <i class="fas fa-table mr-3"></i>Account</a>
            <a href="{{route('withdrawal.index')}}" class="list-group-item list-group-item-action waves-effect  text-white">
                <i class="fas fa-map mr-3"></i>Withdraw</a>
            <a href="history.html" class="list-group-item list-group-item-action waves-effect  text-white">
                <i class="fas fa-archway mr-3"></i>History</a>
            <a href="{{route('settings.index')}}" class="list-group-item list-group-item-action waves-effect  text-white">
                <i class="fas fa-users-cog mr-3"></i>Settings</a>

            <a href="{{route('logout')}}" class="list-group-item list-group-item-action waves-effect  my-3" style="color:#fff;"
