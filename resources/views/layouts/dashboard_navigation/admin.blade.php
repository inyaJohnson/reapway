...
<p id="collapseExample" class="collapse ml-2 panel-collapse">
    <a href="{{route('packages.create')}}" class="list-group-item  waves-effect">
...
<a  data-toggle="collapse" href="#usermanagementCollapse" role="button" aria-expanded="false" aria-controls="usermanagementCollapse" class="list-group-item list-group-item-action waves-effect  text-white">
...
<a href="{{route('user.blocked')}}" class="list-group-item list-group-item-action waves-effect ">
