...
<a href="{{route('withdrawal')}}" class="list-group-item list-group-item-action waves-effect text-white">
    <i class="fas fa-map mr-2"></i>Withdraw</a>
<a href="{{route('withdrawal.transaction')}}" class="list-group-item list-group-item-action waves-effect text-white ">
