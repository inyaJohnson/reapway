                                        ...
                                        <td>
                                            ...
                                            @else
                                                <a href="{{route('investment.reinvest', $investment->id)}}"
                                                   ...
                                                   style="padding: 10px; font-size: 1em; border-radius: 5px; border:none; margin-top: 10px;">Reinvest</a>
                                                <a href="{{route('investment.withdraw', $investment->id)}}"
                                                   ...
                                                   style="padding: 10px; font-size: 1em; border-radius: 5px; border:none; margin-top: 10px;">Withdraw</a>
                                            @endif
